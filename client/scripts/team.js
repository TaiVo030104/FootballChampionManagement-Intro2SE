    ...
    pageTeams.forEach((team, index) => {
        ...
        row.innerHTML = `
            ...
            <td class="team-actions">
                <div class="actions">
                    <span class="edit-icon" onclick="editItem(${startIndex + index})">
...
function setupSearch() {
    ...
    searchInput.addEventListener('input', () => {
        ...
        filteredData = teamData.filter(item => item.teamName.toLowerCase().includes(query));
...
function updatePagination(data) {
    const pagination = document.querySelector('.pagination.home-product__pagination');
...
async function deleteItem(index) {
    ...
    try {
        const response = await fetch(`${API_BASE}/${teamId}`, { method: 'DELETE' });
        if (response.ok) {
...
function editItem(index) {
    ...
    row.innerHTML = `
        <td>${team.id}</td>
        <td><input type="text" value="${team.teamName}" id="edit-teamName-${index}"></td>
        <td><input type="text" value="${team.teamLeader}" id="edit-teamName-${index}"></td>
        <td><input type="text" value="${team.homeGround}" id="edit-homeGround-${index}"></td>
        <td><input type="text" value="${team.teamSize}" id="edit-teamName-${index}"></td>
         <td class="team-actions">
